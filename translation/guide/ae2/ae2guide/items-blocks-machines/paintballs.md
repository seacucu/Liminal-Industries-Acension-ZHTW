...
顏料彈要放進 <ItemLink id="color_applicator" /> 使用，替[線纜](cables.md)、羊毛、陶土、玻璃、
混凝土這類可上色的方塊上色。也可以裝進 <ItemLink id="matter_cannon" /> 射出，在牆上打出一小片顏料。
...
它們的作用和一般顏料彈完全相同，只是從 <ItemLink id="matter_cannon" /> 射出後，打上去的顏料會發光。
大概可以當信號槍用吧。
